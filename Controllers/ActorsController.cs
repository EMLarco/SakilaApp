...
namespace SakilaApp.Controllers
{
    ...
    public class ActorsController : Controller
    {
        ...
        // ==========================================
        // EJERCICIO 11
        // Mostrar los 5 actores siguientes después del primero, ordenados por apellido.
        // ==========================================
        ...
        // ==========================================
        // EJERCICIO 13
        // Mostrar los 10 actores cuyos apellidos empiecen con la letra S.
        // ==========================================
        // public async Task<IActionResult> Index()
        // {
        //     var actores = await _context.Actors
        //         .Where(a => EF.Functions.ILike(a.LastName, "S%"))
        //         .Take(10)
        //         .ToListAsync();
        //     return View(actores);
        // }
        ...
        // ==========================================
        // EJERCICIO 14
        // Mostrar los 5 actores cuyos nombres contengan la cadena JO.
        // ==========================================
        // public async Task<IActionResult> Index()
        // {
        //     var actores = await _context.Actors
        //         .Where(a => EF.Functions.ILike(a.FirstName, "%JO%"))
        //         .Take(5)
        //         .ToListAsync();
        //     return View(actores);
        // }
        ...
        // ==========================================
        // Index ACTIVO (por defecto: primeros 100 actores)
        // ==========================================
        public async Task<IActionResult> Index()
        {
            var actores = await _context.Actors.Take(100).ToListAsync();
            return View(actores);
        }
